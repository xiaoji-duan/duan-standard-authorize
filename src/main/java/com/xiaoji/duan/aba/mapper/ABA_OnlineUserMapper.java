...
public interface ABA_OnlineUserMapper {
	...
	@Update("UPDATE ABA_OnlineUser SET ACCESS_TOKEN = #{accessToken}, EXPIRES_IN = #{expiresIn}, REFRESH_TOKEN = #{refreshToken}, OPENID = #{openId}, CODE = #{code}, SCOPE = #{scope}, LOGON_TIME = Now(), CREATE_TIME = Now() WHERE UNIONID = #{unionId}")
	...
	public int updateWithoutCode(ABA_OnlineUser ou);
}
